...
extern const uint32_t IErrorInfo_GetGUID_m204183467_CCW_ManagedErrorInfo_t3638106899_ComCallableWrapper_ManagedErrorInfo_GetGUID_m3942627118_MetadataUsageId;
extern const uint32_t IErrorInfo_GetSource_m1512047144_CCW_ManagedErrorInfo_t3638106899_ComCallableWrapper_ManagedErrorInfo_GetSource_m4201188279_MetadataUsageId;
extern const uint32_t IErrorInfo_GetDescription_m4221667195_CCW_ManagedErrorInfo_t3638106899_ComCallableWrapper_ManagedErrorInfo_GetDescription_m1982426204_MetadataUsageId;
extern const uint32_t IErrorInfo_GetHelpFile_m2971244315_CCW_ManagedErrorInfo_t3638106899_ComCallableWrapper_ManagedErrorInfo_GetHelpFile_m555519223_MetadataUsageId;
extern const uint32_t IErrorInfo_GetHelpContext_m1450781758_CCW_ManagedErrorInfo_t3638106899_ComCallableWrapper_ManagedErrorInfo_GetHelpContext_m125805616_MetadataUsageId;
struct Guid_t ;
...
extern "C"  int32_t ManagedErrorInfo_GetGUID_m3942627118 (ManagedErrorInfo_t3638106899 * __this, Guid_t * ___guid0, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
// System.Int32 System.Runtime.InteropServices.ManagedErrorInfo::GetSource(System.String&)
extern "C"  int32_t ManagedErrorInfo_GetSource_m4201188279 (ManagedErrorInfo_t3638106899 * __this, String_t** ___source0, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
// System.Int32 System.Runtime.InteropServices.ManagedErrorInfo::GetDescription(System.String&)
extern "C"  int32_t ManagedErrorInfo_GetDescription_m1982426204 (ManagedErrorInfo_t3638106899 * __this, String_t** ___description0, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
// System.Int32 System.Runtime.InteropServices.ManagedErrorInfo::GetHelpFile(System.String&)
extern "C"  int32_t ManagedErrorInfo_GetHelpFile_m555519223 (ManagedErrorInfo_t3638106899 * __this, String_t** ___helpFile0, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
// System.Int32 System.Runtime.InteropServices.ManagedErrorInfo::GetHelpContext(System.UInt32&)
extern "C"  int32_t ManagedErrorInfo_GetHelpContext_m125805616 (ManagedErrorInfo_t3638106899 * __this, uint32_t* ___helpContext0, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;

// COM Callable Wrapper for System.Runtime.InteropServices.ManagedErrorInfo
struct ManagedErrorInfo_t3638106899_ComCallableWrapper IL2CPP_FINAL : il2cpp::vm::CachedCCWBase<ManagedErrorInfo_t3638106899_ComCallableWrapper>, IErrorInfo_t2592127289
{
	inline ManagedErrorInfo_t3638106899_ComCallableWrapper(RuntimeObject* obj) : il2cpp::vm::CachedCCWBase<ManagedErrorInfo_t3638106899_ComCallableWrapper>(obj) {}
	...
	virtual il2cpp_hresult_t STDCALL QueryInterface(const Il2CppGuid& iid, void** object) IL2CPP_OVERRIDE
	{
		...
		if (::memcmp(&iid, &IErrorInfo_t2592127289::IID, sizeof(Il2CppGuid)) == 0)
		{
			*object = static_cast<IErrorInfo_t2592127289*>(this);
			AddRefImpl();
			return IL2CPP_S_OK;
		}
	...
	virtual il2cpp_hresult_t STDCALL IErrorInfo_GetGUID_m204183467(Guid_t * ___guid0, int32_t* comReturnValue) IL2CPP_OVERRIDE
	{
		static bool s_Il2CppMethodInitialized;
		if (!s_Il2CppMethodInitialized)
		{
			il2cpp_codegen_initialize_method (IErrorInfo_GetGUID_m204183467_CCW_ManagedErrorInfo_t3638106899_ComCallableWrapper_ManagedErrorInfo_GetGUID_m3942627118_MetadataUsageId);
		...
		try
		{
			ManagedErrorInfo_t3638106899 * __thisValue = (ManagedErrorInfo_t3638106899 *)GetManagedObjectInline();
			returnValue = ManagedErrorInfo_GetGUID_m3942627118(__thisValue, (&____guid0_empty), NULL);
		}
	...
	virtual il2cpp_hresult_t STDCALL IErrorInfo_GetSource_m1512047144(Il2CppChar** ___source0, int32_t* comReturnValue) IL2CPP_OVERRIDE
	{
		static bool s_Il2CppMethodInitialized;
		if (!s_Il2CppMethodInitialized)
		{
			il2cpp_codegen_initialize_method (IErrorInfo_GetSource_m1512047144_CCW_ManagedErrorInfo_t3638106899_ComCallableWrapper_ManagedErrorInfo_GetSource_m4201188279_MetadataUsageId);
			s_Il2CppMethodInitialized = true;
		}
		il2cpp_native_wrapper_vm_thread_attacher _vmThreadHelper;
		...
		{
			ManagedErrorInfo_t3638106899 * __thisValue = (ManagedErrorInfo_t3638106899 *)GetManagedObjectInline();
			returnValue = ManagedErrorInfo_GetSource_m4201188279(__thisValue, (&____source0_empty), NULL);
		}
		catch (const Il2CppExceptionWrapper& ex)
		{
			*comReturnValue = 0;
	...
	virtual il2cpp_hresult_t STDCALL IErrorInfo_GetDescription_m4221667195(Il2CppChar** ___description0, int32_t* comReturnValue) IL2CPP_OVERRIDE
	{
		static bool s_Il2CppMethodInitialized;
		if (!s_Il2CppMethodInitialized)
		{
			il2cpp_codegen_initialize_method (IErrorInfo_GetDescription_m4221667195_CCW_ManagedErrorInfo_t3638106899_ComCallableWrapper_ManagedErrorInfo_GetDescription_m1982426204_MetadataUsageId);
			s_Il2CppMethodInitialized = true;
		}
		il2cpp_native_wrapper_vm_thread_attacher _vmThreadHelper;
		...
		{
			ManagedErrorInfo_t3638106899 * __thisValue = (ManagedErrorInfo_t3638106899 *)GetManagedObjectInline();
			returnValue = ManagedErrorInfo_GetDescription_m1982426204(__thisValue, (&____description0_empty), NULL);
		}
		catch (const Il2CppExceptionWrapper& ex)
		{
			*comReturnValue = 0;
	...
	virtual il2cpp_hresult_t STDCALL IErrorInfo_GetHelpFile_m2971244315(Il2CppChar** ___helpFile0, int32_t* comReturnValue) IL2CPP_OVERRIDE
	{
		static bool s_Il2CppMethodInitialized;
		if (!s_Il2CppMethodInitialized)
		{
			il2cpp_codegen_initialize_method (IErrorInfo_GetHelpFile_m2971244315_CCW_ManagedErrorInfo_t3638106899_ComCallableWrapper_ManagedErrorInfo_GetHelpFile_m555519223_MetadataUsageId);
			s_Il2CppMethodInitialized = true;
		}
		il2cpp_native_wrapper_vm_thread_attacher _vmThreadHelper;
		...
		{
			ManagedErrorInfo_t3638106899 * __thisValue = (ManagedErrorInfo_t3638106899 *)GetManagedObjectInline();
			returnValue = ManagedErrorInfo_GetHelpFile_m555519223(__thisValue, (&____helpFile0_empty), NULL);
		}
		catch (const Il2CppExceptionWrapper& ex)
		{
			*comReturnValue = 0;
	...
	virtual il2cpp_hresult_t STDCALL IErrorInfo_GetHelpContext_m1450781758(uint32_t* ___helpContext0, int32_t* comReturnValue) IL2CPP_OVERRIDE
	{
		static bool s_Il2CppMethodInitialized;
		if (!s_Il2CppMethodInitialized)
		{
			il2cpp_codegen_initialize_method (IErrorInfo_GetHelpContext_m1450781758_CCW_ManagedErrorInfo_t3638106899_ComCallableWrapper_ManagedErrorInfo_GetHelpContext_m125805616_MetadataUsageId);
			s_Il2CppMethodInitialized = true;
		}
		il2cpp_native_wrapper_vm_thread_attacher _vmThreadHelper;
		...
		{
			ManagedErrorInfo_t3638106899 * __thisValue = (ManagedErrorInfo_t3638106899 *)GetManagedObjectInline();
			returnValue = ManagedErrorInfo_GetHelpContext_m125805616(__thisValue, (&____helpContext0_empty), NULL);
		}
		catch (const Il2CppExceptionWrapper& ex)
		{
			*comReturnValue = 0;
...
extern "C" Il2CppIUnknown* CreateComCallableWrapperFor_ManagedErrorInfo_t3638106899(RuntimeObject* obj)
{
	void* memory = il2cpp::utils::Memory::Malloc(sizeof(ManagedErrorInfo_t3638106899_ComCallableWrapper));
	if (memory == NULL)
	{
		il2cpp_codegen_raise_out_of_memory_exception();
	}

	return static_cast<Il2CppIManagedObjectHolder*>(new(memory) ManagedErrorInfo_t3638106899_ComCallableWrapper(obj));
}
